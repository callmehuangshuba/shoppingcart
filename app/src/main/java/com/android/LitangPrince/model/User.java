...
public class User implements Serializable {
    ...
    public User(String username, String password, String nickname, Bitmap headImage1) {
        this.username = username;
        this.password = password;
        this.nickname = nickname;
    ...
    public Bitmap getHeadImage1() {
        return headImage1;
    }

    public void setHeadImage1(Bitmap headImage1) {
        this.headImage1 = headImage1;
    }
